...
async def check_deepseek_api_status():
    ...
    try:
        ...
        logger.info(f"✅ API ключ: {'*' * 20}...{config.deepseek.deepseek_api_key[-8:]}")
        ...
        async with httpx.AsyncClient(
            ...
            if response.status_code == 200:
                ...
                logger.info("   1. Войдите в личный кабинет DeepSeek: https://platform.deepseek.com/")
...
async def check_balance_info():
    ...
    try:
        ...
        async with httpx.AsyncClient(
            ...
            try:
                balance_response = await client.get("/v1/dashboard/billing/subscription")
