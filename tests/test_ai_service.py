...
class TestAIService:
    ...
    async def test_generate_response_success(self, mock_api_request, ai_service, mock_config):
    ...
    @patch('app.services.ai_service.AIService._make_api_request')
    async def test_generate_response_with_cache(self, mock_api_request, ai_service, mock_config):
