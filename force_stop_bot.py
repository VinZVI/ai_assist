    ...
    try:
        ...
        async with httpx.AsyncClient(timeout=30.0) as client:
            ...
            for attempt in range(3):
                ...
                try:
                    response = await client.post(delete_url, json={
            ...
            try:
                ...
                if info_response.status_code == 200:
                    ...
                    if info_data.get("ok"):
                        ...
                        pending_updates = info_data.get("result", {}).get("pending_update_count", 0)
                        
                        logger.info(f"📊 Финальный статус webhook: {webhook_url or 'очищен'}")
        ...
        async with httpx.AsyncClient(timeout=10.0) as client:
            ...
            if response.status_code == 200:
                ...
                if data.get("ok"):
                    ...
                    logger.success(f"✅ Бот готов: @{bot_info.get('username', 'unknown')}")
                    return True
