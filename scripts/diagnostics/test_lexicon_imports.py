...
def test_lexicon_imports():
    ...
    try:
        ...
        from app.lexicon import start, message, callbacks
        print("✅ Основные лексиконы импортируются успешно")
        
        # Тест импорта новых лексиконов
        from app.lexicon import keyboards, ai_providers, utils
        print("✅ Новые лексиконы импортируются успешно")
        
        # Тест импорта лог-лексиконов (только новые модули)
        from app.log_lexicon import start as log_start, message as log_message, callbacks as log_callbacks
        print("✅ Основные лог-лексиконы импортируются успешно")
        
        # Тест импорта новых лог-лексиконов
        from app.log_lexicon import keyboards as log_keyboards, ai_providers as log_ai_providers, utils as log_utils
