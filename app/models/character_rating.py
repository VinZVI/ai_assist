...
class CharacterRating(Base):
    ...
    id: Mapped[int] = mapped_column(
        Integer, primary_key=True, comment="Уникальный ID рейтинга"
    )
    ...
    rating: Mapped[int] = mapped_column(
        Integer, nullable=False, comment="Рейтинг (1 = дизлайк, 5 = лайк)"
    )
    ...
    # Связи
    character: Mapped["Character"] = relationship("Character", back_populates="ratings")
