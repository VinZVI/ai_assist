...
VALIDATOR_INVALID_DEEPSEEK_TEMPERATURE = "DEEPSEEK_TEMPERATURE must be between 0.0 and 2.0"
...
VALIDATOR_INVALID_OPENROUTER_TEMPERATURE = "OPENROUTER_TEMPERATURE must be between 0.0 and 2.0"
VALIDATOR_INVALID_OPENROUTER_MAX_TOKENS = "OPENROUTER_MAX_TOKENS must be between 1 and 8000"