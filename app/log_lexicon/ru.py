...
LOG_LEXICON_RU = {
    ...
    "middleware": {
        ...
        "anti_spam_limit_exceeded": "🛡️ Пользователь ID:{user_id} превысил лимит действий ({actions_count}/{limit})",
        "anti_spam_message_error": "💥 Ошибка отправки сообщения о превышении лимита спама: {error}",
        "anti_spam_callback_error": "💥 Ошибка отправки callback ответа о превышении лимита спама: {error}",
        "daily_limit_exceeded": "🚫 Пользователь ID:{user_id} превысил дневной лимит сообщений ({daily_count}/{limit})",
        "daily_limit_message_error": "💥 Ошибка отправки сообщения о превышении дневного лимита: {error}",
    ...
    "payment": {
        "invoice_created": "💳 Создан инвойс для пользователя ID:{user_id} на сумму {amount} XTR",
        "invoice_creation_error": "💥 Ошибка создания инвойса для пользователя ID:{user_id}: {error}",
        "payment_processed": "💰 Обработан платеж пользователя ID:{user_id} на сумму {amount} XTR, подписка на {duration} дней",
        "payment_handling_error": "💥 Ошибка обработки платежа пользователя ID:{user_id}: {error}",
        "premium_activated": "⭐ Активирован премиум для пользователя ID:{user_id} до {expires_at} (на {duration} дней)",
        "premium_activation_failed": "💥 Ошибка активации премиум для пользователя ID:{user_id}",
        "premium_activation_error": "💥 Ошибка активации премиум для пользователя ID:{user_id}: {error}",
        "premium_deactivated": "🔴 Деактивирован премиум для пользователя ID:{user_id}",
        "premium_deactivation_error": "💥 Ошибка деактивации премиум для пользователя ID:{user_id}: {error}",
        "premium_status_check_error": "💥 Ошибка проверки статуса премиум для пользователя ID:{user_id}: {error}",
        "user_not_found": "👤 Пользователь не найден при активации премиум: ID:{user_id}",
        "invalid_payload": "📄 Неверный формат payload: {payload}",
    },
    "admin": {
