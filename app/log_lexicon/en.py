...
LOG_LEXICON_EN = {
    ...
    "middleware": {
        ...
        "anti_spam_limit_exceeded": "🛡️ User ID:{user_id} exceeded action limit ({actions_count}/{limit})",
        "anti_spam_message_error": "💥 Error sending spam limit message: {error}",
        "anti_spam_callback_error": "💥 Error sending spam limit callback response: {error}",
        "daily_limit_exceeded": "🚫 User ID:{user_id} exceeded daily message limit ({daily_count}/{limit})",
        "daily_limit_message_error": "💥 Error sending daily limit message: {error}",
    ...
    "payment": {
        "invoice_created": "💳 Created invoice for user ID:{user_id} for amount {amount} XTR",
        "invoice_creation_error": "💥 Error creating invoice for user ID:{user_id}: {error}",
        "payment_processed": "💰 Processed payment for user ID:{user_id} for amount {amount} XTR, subscription for {duration} days",
        "payment_handling_error": "💥 Error handling payment for user ID:{user_id}: {error}",
        "premium_activated": "⭐ Activated premium for user ID:{user_id} until {expires_at} (for {duration} days)",
        "premium_activation_failed": "💥 Failed to activate premium for user ID:{user_id}",
        "premium_activation_error": "💥 Error activating premium for user ID:{user_id}: {error}",
        "premium_deactivated": "🔴 Deactivated premium for user ID:{user_id}",
        "premium_deactivation_error": "💥 Error deactivating premium for user ID:{user_id}: {error}",
        "premium_status_check_error": "💥 Error checking premium status for user ID:{user_id}: {error}",
        "user_not_found": "👤 User not found when activating premium: ID:{user_id}",
        "invalid_payload": "📄 Invalid payload format: {payload}",
    },
    "admin": {
